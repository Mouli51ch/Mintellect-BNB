...
const CONTRACT_ADDRESS = "0xe99a33535404A4A29B5dAa415BB16E5a5aC131C4"
              ...
              >
                <GlassCard className="h-full flex flex-col overflow-hidden transition-all duration-300">
                  ...
                  <div className="mt-4 flex justify-between items-center">
                    ...
                    <a
                      href={`https://testnet.bscscan.com/token/0xe99a33535404A4A29B5dAa415BB16E5a5aC131C4?a=${cert.tokenId}`}
                      target="_blank"
